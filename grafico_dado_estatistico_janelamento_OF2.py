...
# Objetivo do código: gráfico dos dados estatíticos ao longo das ocupações de acordo com o janelamento para o método do Filtro Ótimo (Optimal Filtering - OF 2).
...
titulo_programa = colored("Plote do gráfico do dado estatístico do erro de estimação da amplitude, fase ou pedestal ao longo das ocupações para um determinado janelamento pelo método do Filtro Ótimo (Optimal Filtering - OF 2):\n", attrs=["bold"])
...
def leitura_dados_estatisticos_janelamento(parametro, n_janelamento):
    ...
    pasta_dados_estatisticos_janelamento = f"Dados_Estatisticos_OF2_{parametro}_OC"

    # Nome do arquivo de entrada dos dados estatísticos de acordo com o janelamento.
    arquivo_dados_estatisticos_janelamento = f"dados_estatisticos_OF2_janelamento_{n_janelamento}.txt"
...
def principal_grafico_dado_estatistico_janelamento_OF2():
...
principal_grafico_dado_estatistico_janelamento_OF2()

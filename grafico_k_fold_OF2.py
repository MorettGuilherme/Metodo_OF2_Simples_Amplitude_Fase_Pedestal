...
titulo_programa = colored("Plote do gráfico da validação cruzada K-Fold para o método do Filtro Ótimo (Optimal Filtering - OF 2):\n", attrs=["bold"])
...
def leitura_dados_estatisticos_k_fold(parametro, n_ocupacao, dado_estatistico):
    ...
    pasta_dados_k_fold = f"K_Fold_{parametro}_{dado_estatistico}_Dados_Estatisticos_OF2_OC"

    # Nome do arquivo de entrada dos dados estatísticos do K-Fold.
    arquivo_dados_k_fold = f"k_fold_{parametro}_{dado_estatistico}_dados_estatisticos_OF2_OC_{n_ocupacao}.txt"
...
def principal_grafico_k_fold():
    ...
    # Caso o valor digitado armazenado na variável parametro não estiver presente na lista valores_dados.
